<?php
    ...
    $data=array();
	$index=$back;
	$query=mysqli_query($conn, "SELECT * FROM sdata_barang INNER JOIN kategori on kategori.id_kategori=sdata_barang.id_kategori where sdata_barang.status_post='Publish' AND sdata_barang.mulai_flash_sale <= '$ts' AND sdata_barang.selesai_flash_sale >= '$ts'");
